      ...
      <div className="error-screen">
        <div className="error-content">
          ...
          <div className="error-actions">
            ...
            {error?.includes("database") || error?.includes("cleared") ? (
              <Link
                to={`/product-input?url=${encodeURIComponent(
    ...
    <div className="product-data-wrapper">
          ...
          <div className="dashboard-container">
            ...
            <div className="panel research-list-panel">
              ...
              <div className="research-cards">
                {(productData.clinical_research || []).map(
                  (research, index) => (
                    <div
                      key={index}
                      className={`research-card ${
                        selectedResearch === index ? "selected" : ""
                      }`}
            ...
            <div className="panel research-detail-panel">
              ...
              productData.clinical_research &&
              productData.clinical_research[selectedResearch] ? (
                <div className="detail-content">
                  ...
                  <div className="detail-metadata">
                    <span>
                      ...
                      {Array.isArray(
                        productData.clinical_research[selectedResearch].metadata
                          .authors
                      )
                        ? productData.clinical_research[
                            selectedResearch
                  ...
                  <a
                    href={
                      productData.clinical_research[selectedResearch].source_url
                    }
                    target="_blank"
                ...
                <div className="detail-placeholder">
                  <p>
                    Select a clinical study from the list to view its details
                    here.
                  </p>
                </div>
              )}
      ...
      {isSearchTermsOpen && (
        <div
          ...
          onClick={(e) =>
            e.target === e.currentTarget && setIsSearchTermsOpen(false)
          }
        >
          <div className="modal-content">
            <button onClick={toggleSearchTerms} className="modal-close-btn">
              &times;
            </button>
