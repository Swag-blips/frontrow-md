...
const ProcessingSuccess: React.FC = () => {
    ...
    const productData: ProductData = {
        ...
        image: "https://www.mateandme.com/cdn/shop/files/duo_front.webp?v=1715284608&width=1646",
        description: "A bundle of goodness, designed for the both of you and your fertility journey. Effective and great tasting with clinically proven ingredients, this perfect prenatal pairing can help boost sperm health and support Mom and baby with key nutrients during preconception and pregnancy. Taking care of each other's health and wellness has never been so sexy.",
        ingredients: ["CoQ10", "Methylated Folate", "Choline", "Vitamin D3", "Vitamin B12", "Vitamin K2", "Antioxidants"],
        ...
        <div className="processing-success-wrapper">
            ...
            <div className="container page-content">
                <div className="page-title-section">
                    <h1 className="page-title">Confirm Product Details</h1>
                    <p className="page-subtitle">
                        Review the extracted data on the left against the product page on the right. 
                        Accept if it's accurate, or reject to try again.
                    </p>
                </div>
                ...
                <main className="validation-container">
                        ...
                        <div className="panel-scrollable">
                            ...
                            <div className="section">
                                ...
                                {productData.clinicianReviews ? (
                                    <p className="product-description">{productData.clinicianReviews}</p>
                                ) : (
                    ...
                    <div className="panel right-panel">
                        ...
                        <p className="external-link-text">
                            Click the button below to open the original product page in a new tab. 
                            Compare it with the extracted data on the left to ensure accuracy.
                        </p>
                        <a 
                            href={url || "https://www.mateandme.com/products/prenatal-gummies-for-him-her"} 
                            target="_blank" 
