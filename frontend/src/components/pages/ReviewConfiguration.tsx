            ...
            <form onSubmit={handleSubmit}>
              <div className="section-header">
                ...
                <p className="section-subtitle">
                  Set the parameters for your AI-generated reviews. Your choices will guide the tone, style, and scientific basis of the output.
                </p>
              </div>
                        ...
                        <div className="range-slider-container">
                          <div 
                            ...
                            style={{
                              ...
                              width: `${((maxWords - minWords) / (200 - 10)) * 100}%`
                            }}
                          ></div>
                          <input
                            type="range"
                ...
                <div className="persona-grid-container">
                  <div className="persona-grid">
                    {Object.entries(personaData).map(([key, persona]) => (
                      <div
                        key={key}
                        className={`persona-card ${selectedPersonas.has(key) ? 'selected' : ''}`}
                      ...
                      >
                        ...
                        <div className="persona-content">
                          ...
                          <span className={`research-tag ${persona.uses_clinical_research ? 'with-research' : 'without-research'}`}>
                            {persona.uses_clinical_research ? 'Research-Based' : 'Experience-Based'}
                          </span>
                        </div>
                        <button
                          type="button"
              ...
              <div className="section">
                <h3 className="section-title">Add Supporting Research (Optional)</h3>
                  ...
                  {researchLinks.map((link, index) => (
                    <div key={index} className="research-input-group">
                      ...
                      <input
                        ...
                        value={link}
                        onChange={(e) => updateResearchLink(index, e.target.value)}
                      />
                      <button
                        type="button"
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-content-body">
              <div className="modal-section">
                ...
                <span className={`modal-tag ${personaData[selectedPersonaKey].uses_clinical_research ? 'with-research' : 'without-research'}`}>
                  {personaData[selectedPersonaKey].uses_clinical_research ? 'Incorporates Clinical Research' : 'Experience-Based Approach'}
                </span>
              ...
              <div className="modal-section">
                ...
                <ul>
                  {personaData[selectedPersonaKey].voice_characteristics.map((char, index) => (
              ...
              <div className="modal-section">
                ...
                <ul>
                  {Object.entries(personaData[selectedPersonaKey].data_incorporation).map(([key, value]) => (
                    <li key={key}>
              ...
              <div className="modal-section">
                <h3>Focus Areas</h3>
                <ul>
                  {personaData[selectedPersonaKey].focus_areas.map((area, index) => (
              ...
              <div className="modal-section modal-example-review">
                ...
                <p><em>"{personaData[selectedPersonaKey].example_10_word_summary}"</em></p>
              </div>
            </div>
          </div>
        </div>
